...
public interface SegmentAPI {
    @GetMapping(value = "/customer-master-data")
    ...
    @GetMapping(value = "/populate-customer-master-data/{id}")
    ResponseEntity<CustomerMasterData> populateCustomerMasterDataById(@PathVariable Long id);
